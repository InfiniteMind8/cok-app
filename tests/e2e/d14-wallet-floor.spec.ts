...
test.describe.skip('D.14 system wallet floor protection', () => {
  test('near-floor: yellow warning banner is visible on Treasury dashboard', async ({ page: _page }) => {
  ...
  test('at-floor: mutation blocked and UI explains the reason', async ({ page: _page }) => {
    // 1. Sign in as MASTER_ADMIN
