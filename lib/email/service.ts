...
import { renderWelcome, type WelcomeData } from './templates/welcome'
import { renderCredentials, type CredentialsData } from './templates/credentials'
import { renderPasswordReset, type PasswordResetData } from './templates/password-reset'
import { renderVoucherDelivery, type VoucherDeliveryData } from './templates/voucher-delivery'
import { renderSettlementConfirmation, type SettlementConfirmationData } from './templates/settlement-confirmation'
import { renderRentalExtensionDecision, type RentalExtensionDecisionData } from './templates/rental-extension-decision'
